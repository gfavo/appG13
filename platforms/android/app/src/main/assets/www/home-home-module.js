...
/* harmony import */ var _labelsHome__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./labelsHome */ "./src/app/home/labelsHome.ts");
...
var HomePage = /** @class */ (function () {
    function HomePage(load, storage, network, httpClient, router, instrutor, alertController, labels, globalization, onesignal, platform) {
        this.load = load;
        ...
        if (this.pessoa.user == "painel" && this.pessoa.pass == "painelmaster123") {
            ...
            if (this.platform.is("cordova")) {
                ...
                this.onesignal.getIds().then(function (res) {
                    _this.pessoa.playerid = res.userId;
                    _this.httpClient
    ...
    HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"],
            ...
            _labelsHome__WEBPACK_IMPORTED_MODULE_9__["LabelsHome"],
