...
var CalendarioPage = /** @class */ (function () {
    ...
    CalendarioPage.prototype.onViewTitleChanged = function (title) {
        ...
        this.subscription = this.httpClient
            ...
            this.mes +
            "&ano=" +
            this.ano, { responseType: "json", headers: this.headers })
            .subscribe(function (data) {
            console.log(data);
