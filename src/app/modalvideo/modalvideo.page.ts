...
export class ModalvideoPage implements OnInit {
  ...
  constructor(private modalController: ModalController,private instrutor: NomeInstrutorService) { }
...
senhavimeo: string;
  ...
  ionViewWillEnter() {
    ...
    (<HTMLIFrameElement>document.getElementById('player')).src = "https://player.vimeo.com/video/"+this.idvimeo;
  }
